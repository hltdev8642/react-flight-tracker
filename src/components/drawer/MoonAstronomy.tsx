                    ...
                    <Table>
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{toDegrees(MoonPosition.ellipticLongitude).toFixed(5)} °</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell>Elliptical Latitude</TableCell>
                                <TableCell>{toDegrees(MoonPosition.ellipticLatitude).toFixed(5)} °</TableCell>
                            </TableRow>
                            <TableRow>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{toDegrees(MoonPosition.geoLongitude).toFixed(5)} °</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell>Latitude</TableCell>
                                <TableCell>{toDegrees(MoonPosition.geoLatitude).toFixed(5)} °</TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </List>
