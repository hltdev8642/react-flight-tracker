...
export default function Camera() {
                ...
                switch (cameraTarget) {
                    ...
                    case "earth": {
                        void cameraControlsRef.current.setTarget(0, 0, 0, true)
                            .then(
                                () => {
                                    void cameraControlsRef.current.dolly(cameraControlsRef.current.distance - EARTH_RADIUS * 2, true).then(
                                        () => {
                                            setIsAnimationRunning(false)
                                        }
                                    )
    ...
    useEffect(() => {
        ...
        ,
        // eslint-disable-next-line react-hooks/exhaustive-deps
        [moonPosition.dec, moonPosition.r, moonPosition.ra, sunPosition.dec, sunPosition.r, sunPosition.ra])
